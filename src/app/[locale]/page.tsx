...
export default async function Home({
  ...
  return (
    <TranslationsProvider
      ...
      resources={resources}
    >
      <div className="dark:bg-dot-white/[0.2] bg-dot-black/[0.2] relative flex  w-full flex-col items-center justify-center gap-12 bg-white dark:bg-black md:gap-16 lg:gap-20">
