      ...
      <div className="z-10 flex flex-col gap-4 text-center lg:text-left">
        ...
        <div className="mx-auto mt-8 lg:mx-0">
          <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
            ...
            <span className="z-10 inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950/50 px-8 py-4 text-lg font-medium text-white backdrop-blur-lg hover:bg-slate-900/70 dark:bg-neutral-50/50 hover:dark:bg-slate-950/70">
              Xem thêm
            </span>
          </button>
        </div>
